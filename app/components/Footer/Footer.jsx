...
export const Footer = () => {
    ...
    return (
        <footer className={Styles["footer"]}>
            {path === '/' ? (<div className={Styles["footer__logo"]}><span className={Styles['footer__logo-name']}>pindie</span><span className={Styles["footer__logo-copy"]}>, XXI век</span></div>) : <Link href="/" className={Styles['footer__logo']}>
            ...
            <ul className={Styles["social-list"]}>
                ...
                <li className={`"button ${Styles['social-list__item']}`}>
